...
const howToHelpItems = [
    ...
    {
        title: "Media Support",
        description: "Promote the event through your social media, website, or newsletter",
        icon: (
            <path
    ...
    },
    {
        ...
        description: "Provide swag for speakers, prizes for the best questions, or treats for attendees",
        icon: (
            <path
    ...
    },
    {
        ...
        description: "Help greet guests, coordinate logistics, and manage the event flow",
        icon: (
            <path
    ...
    },
    {
        ...
        description: "Provide essential equipment: projectors, microphones, or live-streaming gear",
        icon: (
            <path
