import { s3Talk } from "@src/core/data/s3";
...
Writing code without an IDE, linters, or a compiler is pure madness. Yet, this is exactly how designers build interfaces every single day. In this talk, we will dissect the data structure of a "messy" mockup and break down why automated UI validation has been considered a mathematically unsolvable problem. We'll explore the fundamental conflict between the freeform Figma canvas and the strict DOM tree and attempt to find a path to cleaner React code.`,
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("s1", "aaaaaaaaaaaaaaaaaaaaaaa-href"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("s1", "what-if-css-if-function"),
        youtube: "https://www.youtube.com/embed/wgyoibJfDzY?si=_vJWdon_IsUF1bRK",
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("s1", "routing-as-the-foundation-of-correct-architecture"),
        youtube: "https://www.youtube.com/embed/wgyoibJfDzY?si=_vJWdon_IsUF1bRK",
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("s1", "3d-graphics-is-an-illusion"),
        youtube: "https://www.youtube.com/embed/wgyoibJfDzY?si=_vJWdon_IsUF1bRK",
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m6", "how-langchain-js-works-and-when-its-useful"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m6", "live-interfaces-how-and-with-what-to-animate-the-web-in-2025"),
        youtube: "https://www.youtube.com/embed/_V03VmjQZvQ?si=HRuWPequbBCofZgK",
        start: "2025-06-14T09:30:00.000Z",
        end: "2025-06-14T09:30:00.000Z",
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m6", "react-19-new-form-management-tools"),
        youtube: "https://www.youtube.com/embed/_V03VmjQZvQ?si=HRuWPequbBCofZgK",
        start: "2025-06-14T09:30:00.000Z",
        end: "2025-06-14T09:30:00.000Z",
    },
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m6", "gamified-prototyping-how-dnd-mechanics-help-to-design-an-llm-voice-assistant"),
        youtube: "https://www.youtube.com/embed/_V03VmjQZvQ?si=HRuWPequbBCofZgK",
        start: "2025-06-14T09:30:00.000Z",
        end: "2025-06-14T09:30:00.000Z",
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m6", "major-minor-patch-without-the-headache"),
        youtube: "https://www.youtube.com/embed/_V03VmjQZvQ?si=HRuWPequbBCofZgK",
        start: "2025-06-14T09:30:00.000Z",
        end: "2025-06-14T09:30:00.000Z",
    },
    {
        ...
        preview: s3Talk("m3", "debugging-page-performance-with-browser-tools"),
    ...
    },
    {
        ...
        preview: s3Talk("m3", "design-system-is-not-about-design-its-about-interaction"),
        type: "talk",
        start: "2024-10-31T17:30:00.000Z",
        end: "2024-10-31T17:30:00.000Z",
    },
    {
        ...
        preview: s3Talk("m3", "managing-an-industrial-battery-fleet-using-react-spa"),
        start: "2024-10-31T17:30:00.000Z",
        end: "2024-10-31T17:30:00.000Z",
    },
    {
        ...
        preview: s3Talk("m3", "how-a-developer-can-help-their-team-lead-grow"),
        start: "2024-10-31T17:30:00.000Z",
        end: "2024-10-31T17:30:00.000Z",
    },
    {
        ...
        labels: ["a11y"],
        type: "talk",
        preview: s3Talk("a11y1", "state-of-a11y"),
    ...
    },
    {
        ...
        labels: ["a11y"],
        preview: s3Talk("a11y1", "accessibility-as-a-decomposition-of-complexity"),
    ...
    },
    {
        ...
        labels: ["a11y"],
        type: "talk",
        preview: s3Talk("a11y1", "accessibility-in-the-clay-pot-industry"),
...
<li>His personal experience, motivation, implementation process, and key takeaways.</li></ul>`,
        ...
        preview: s3Talk("m5", "react-server-components"),
        type: "talk",
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("a11y1", "speedrun-through-accessibility"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("a11y1", "accessibility-and-typography"),
    ...
    },
    {
        ...
        labels: ["ux", "design"],
        type: "talk",
        preview: s3Talk("a11y1", "what-is-this-ux-thing-anyway"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m4", "how-to-write-interface-texts-without-ux-writer"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m4", "the-browser-as-a-platform-for-heavy-applications"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m4", "echoes-of-exclusion-bias-in-generative-ai"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m4", "infrastructure-as-typescript"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m5", "generative-art-on-js"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m5", "remember-everything"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m5", "an-easy-way-to-quit-react"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m5", "the-journey-from-frontend-to-fullstack-engineering-team"),
...
Anna Shiryaeva, Lead Frontend Developer at Sibur Digital and organizer of MoscowJS, will deliver a talk about compilers, focusing on React Compiler. We'll examine the problems it solves and how it impacts current React mechanisms.`,
        ...
        preview: s3Talk("pd1", "three-stages-of-accepting-react-compiler"),
...
Daniil Savitsky, Senior Frontend Developer at Quantori, an advocate for simple solutions and almost a сlojurist, returns with a new talk, as always, with an intriguing title.`,
        ...
        preview: s3Talk("pd1", "9-and-a-half-weeks-before-release"),
    ...
    },
    {
        ...
        preview: s3Talk("pd1", "practice-of-the-financial-chart-optimization"),
    ...
    },
    {
        ...
        preview: s3Talk("pd1", "when-performance-optimizations-backfire"),
    ...
    },
    {
        ...
        labels: ["rust", "basics"],
        type: "talk",
        preview: s3Talk("r1", "introduction-rust-and-its-basic-concepts"),
    ...
    },
    {
        ...
        labels: ["rust", "backend"],
        preview: s3Talk("r1", "rust-as-a-tool-for-developing-backend-services"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("r1", "rust-as-a-tool-for-developing-frontend-applications"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m1", "dial-m-for-maintainability-part-1"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m1", "contributing-to-doka"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m1", "frontend-in-biotech"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m1", "cloud-serverless-for-frontend"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m2", "modern-ui-kit-libraries"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m2", "dynamic-environments-in-frontend"),
        start: "2024-03-28T16:30:00.000Z",
        end: "2024-03-28T16:30:00.000Z",
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m2", "another-way-to-localise-websites"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("c1", "serverless-your-first-lambda"),
    ...
    },
    {
        ...
        preview: s3Talk("c1", "how-to-develop-through-mentorship"),
    ...
    },
    {
        ...
        labels: ["maintainability", "code-quality"],
        type: "talk",
        preview: s3Talk("c1", "dial-m-for-maintainability-part-2"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("c1", "frontend-across-borders"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("c1", "beyond-the-frontend"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("c1", "tests-you-dont-need"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("c1", "why-should-you-write"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("c1", "getting-into-webgl"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("c1", "storybook-the-cookbook"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("c1", "why-do-we-create-communities"),
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m7", "how-browsers-render-shadows-and-curves"),
        youtube: "",
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m7", "responsive-typography-in-web"),
        youtube: "",
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m7", "growing-as-a-developer-long-term"),
        youtube: "",
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m7", "writing-a-compiler-for-a-disappearing-framework"),
        youtube: "",
    ...
    },
    {
        ...
        type: "talk",
        preview: s3Talk("m7", "microfrontends-business-vs-development"),
        youtube: "",
