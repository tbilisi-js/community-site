...
<li>His personal experience, motivation, implementation process, and key takeaways.</li></ul>`,
    ...
    },
    {
        ...
        description:
            "Timur Gafiulin, developer and author of the Telegram channel TatarinFrontend, will share his experience as a developer who actively contributes to his team lead’s professional and personal growth. He’ll discuss practical steps, strategies, and methods — from reverse mentoring to collaborative learning — that create a supportive environment for leadership development.",
    ...
    {
        slug: "server-components-what-how-and-most-importantly-why",
        speaker: "alexander-saveliev",
        name: "Server Components: What, How, and Most Importantly, Why?",
        description:
            "Alexander Saveliev, Frontend Developer, Next.js contributor, and author of articles on the ecosystem, will finally answer the ultimate question of life, the universe, and everything—while reflecting on two years of React Server Components in production.",
        labels: ["react", "server-components", "nextjs"],
        type: "offline",
        start: "2026-02-22T19:20:00.000Z",
        end: "2026-02-22T19:50:00.000Z",
    },
    {
